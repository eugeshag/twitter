...
const Sidebar = () => {
  ...
  return (
    <div className="relative flex h-full w-90 flex-col px-5 py-5">
      ...
      {results.length > 0 && (
        <div className="absolute top-20 left-5 w-[calc(100%-40px)] rounded-4xl bg-white px-5 py-5 shadow-lg">
          {results.map((user) => (
            <Link
